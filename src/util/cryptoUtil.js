/**
 * cryptoUtil for something about crypto
 */
import { KEYUTIL } from 'jsrsasign'
import sjcl from 'sjcl'
import forge from 'node-forge'
const LOGIN_DIFFICULTY = '0400'
const CRYPT_LOOP_MAX = Math.pow(2, 32)
...
export default {
   ...
   * the server, and an RSAKey object(http://kjur.github.io/jsrsasign/api/symbols/RSAKey.html)
